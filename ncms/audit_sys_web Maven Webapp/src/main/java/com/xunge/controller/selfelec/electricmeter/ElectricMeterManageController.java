package com.xunge.controller.selfelec.electricmeter;
...
/**
 * @description 自维电费 电表管理 Controller
 * @author yuefy
 * @date 创建时间：2017年9月18日
 */
@Controller      
@RequestMapping("asserts/tpl/selfelec/electricmeter")
public class ElectricMeterManageController extends BaseException {
    ...
    public BaseRet delElectricMeter(String ids){
    	...
    	paraMap.put("array", idArray);
    	paraMap.put("meterState", StateComm.STATE__1);
    	boolean result= electicMeterService.updateMeterState(paraMap);
    	if(result){
    		ret.setStatus(SelfelecComm.STATUS_0);
    		ret.setMessage(PromptMessageComm.OPERATION_SUSSESS);
    	}
