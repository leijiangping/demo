...
function selectFileList(){
	...
	$.ajax({
		...
		success : function(back) {
			if(back.success == 1){
				if(back.obj!=null&&back.obj.list!=null){
		...
		success : function(back) {
			if(back != null){
				if(back.success == "1"){
					...
					$("#contractStartdate").val(VEleContract.contractStartdate != null ?new Date(VEleContract.contractStartdate).format("yyyy-MM-dd") : "");
					$("#contractEnddate").val(VEleContract.contractEnddate != null ?new Date(VEleContract.contractEnddate).format("yyyy-MM-dd") : "");
					...
					if(optype == 3){
						...
						$("#contractId").val(contractId);
						$("#dataFrom").val(VEleContract.dataFrom);
						$("#elecontractId").val(elecontractId);
					}
					//电费信息
