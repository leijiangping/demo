...
function audit(){
	...
	window.location.href='respointAuditNews.html?baseresourceId='+id+'&taskId='+taskId+"&regId="+regId;
}
//导出
/*function exportData(){
	$.ajax({
...
function exportData(data){
	...
	para+="&region="+$('#region option:selected').val()+"&status="+$("#status option:selected").val()+"&queryType="+resType+"&resType="+resType;
