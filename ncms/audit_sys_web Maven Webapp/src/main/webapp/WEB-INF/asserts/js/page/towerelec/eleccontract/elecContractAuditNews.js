		...
		success : function(back) {
			if(back != null){
				if(back.success == "1"){
					...
					$("#contractStartdate").html(new Date(VEleContract.contractStartdate).format("yyyy-MM-dd"));
					$("#contractEnddate").html(new Date(VEleContract.contractEnddate).format("yyyy-MM-dd"));
