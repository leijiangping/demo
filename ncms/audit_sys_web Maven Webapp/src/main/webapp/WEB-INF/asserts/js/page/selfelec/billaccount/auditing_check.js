...
//根据报账点id查询报账点信息
function selectBillaccountInfo(){
	var billaccountId = getParameter("billaccountId");
	$.ajax({
	  type : "POST",
...
function auditingsave(){
	...
	var pregId=billaccountInfo.pregId;
