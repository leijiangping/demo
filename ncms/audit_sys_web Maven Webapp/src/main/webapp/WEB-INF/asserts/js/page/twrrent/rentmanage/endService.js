...
function loadTableData(){
	...
	$("#tb").bootstrapTable({
		...
		url : "queryTowerStopServer", // 获取数据的地址
		striped : true, // 表格显示条纹
...
function importTowerStopServer(){
	//"铁塔侧账单导入" 弹出框名称
	//"_towerBillbalance" 功能标识
	//"formSubmit" 回调方法
	importModel("铁塔终止服务信息导入","_towerStopServer","formSubmit");//弹出导入框
}	
/**
 * 上传文件并保存到数据库
 * @param suffix 模块标识
 ...
 * 导出
 */
function exportTowerStopServer(){
...
function exportInfo(){
	...
	window.open("exportTowerStopServer?"+para,"_blank");
}
