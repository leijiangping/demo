...
function showJTopoToobar(stage){
	var toobarDiv = $('<div class="jtopo_toolbar" style="margin:10px auto;">').html(''
		+'<input type="button" id="backBtn" name="backBtn" class="btn btn-primary" value="返回上一页"/>&nbsp;&nbsp;'
		...
		+'&nbsp;&nbsp;<input type="button" id="centerButton" class="btn btn-default" value="居中显示"/> '
		+'<input type="button" id="fullScreenButton" class="btn btn-default" value="全屏显示"/>&nbsp;'
		+'<input type="button" id="zoomOutButton" class="btn btn-default" value=" 放 大 " />&nbsp;'
		+'<input type="button" id="zoomInButton" class="btn btn-default" value=" 缩 小 " />&nbsp; '
		+'<input type="checkbox" id="zoomCheckbox"/>&nbsp;<label for="zoomCheckbox">鼠标缩放</label>'
		+'&nbsp;&nbsp;<input type="text" id="findText" style="width: 100px;height:34px;" value="" onkeydown="enterPressHandler(event)">'
		+ '<input type="button" id="findButton" style="height:34px;" value=" 查 询 ">' 
		//+ '&nbsp;&nbsp;<input type="button" id="cloneButton" value="选中克隆">'
		+'&nbsp;&nbsp;<input type="button" id="exportButton" class="btn btn-default" value="导出PNG">'
