...
function loadTableData(){
	...
	$("#tb").bootstrapTable({
		...
		url : "queryDoGrpDataCollectVO", // 获取数据的地址
		striped : true, // 表格显示条纹
		...
		queryParams : function queryParams(params) { // 设置查询参数
			...
			var param = {
					...
					startDatacollectDate : $("#startDatacollectDate").val(),
					endDatacollectDate : $("#endDatacollectDate").val(),
...
function detailsFormatter(value, row, index){
	return '<a href="collectionDataDistributeExamine.html?datacollectId='+row.datacollectId+'">'+value+'</a>';
}
/**
 * 短信发送状态弹出页面
 * */
