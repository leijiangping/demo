	...
	$("#tb").bootstrapTable({
		...
		columns: [{
            ...
            formatter:function(value,row,index){
            	if(row["auditingState"] == 9||row["auditingState"] == 0){
...
function reviewPopup(){
	...
	if (ids.length <= 0) {
	 ...
	 var pregId=$("#city").val();
	 window.location.href='auditing_check.html?billaccountId='+ids[0].billaccountId+'&taskId='+taskId+'&pregId='+pregId;
}
