package com.xunge.service.activity.service.rest.servlet;
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		if (parms.containsKey("callback")) {
			if (log.isDebugEnabled())
				log.debug(PromptMessageComm.WRAPPING_RESPONSE_WITH_JSONP_CALLBACK + parms.get("callback")[0] + "'");
			...
			wrapper.setContentType(PromptMessageComm.CONTENT_TYPE_TEXT_JAVASCRIPT);
