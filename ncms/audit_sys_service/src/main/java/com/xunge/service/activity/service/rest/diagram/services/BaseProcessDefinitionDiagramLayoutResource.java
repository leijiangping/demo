package com.xunge.service.activity.service.rest.diagram.services;
...
public class BaseProcessDefinitionDiagramLayoutResource {
	...
	public ObjectNode getDiagramNode(String processInstanceId, String processDefinitionId) {
		...
		if (processInstanceId != null) {
			...
			if (processInstance == null) {
				throw new ActivitiObjectNotFoundException(PromptMessageComm.PROCESS_INSTANCE_NOT_FOUND);
			}
		...
		if (processDefinitionId == null) {
			throw new ActivitiObjectNotFoundException(PromptMessageComm.NO_PROCESS_DEF_ID);
		}

		ProcessDefinitionEntity processDefinition = (ProcessDefinitionEntity) repositoryService.getProcessDefinition(processDefinitionId);

		if (processDefinition == null) {
			throw new ActivitiException(PromptMessageComm.PROCESS_DEF + processDefinitionId + PromptMessageComm.NOT_FOUND);
		}
	...
	private void getActivity(String processInstanceId, ActivityImpl activity, ArrayNode activityArray, ArrayNode sequenceFlowArray,
		...
		String multiInstance = (String) activity.getProperty(PromptMessageComm.MULTI_INSTANCE);
		if (multiInstance != null) {
			if (!PromptMessageComm.SEQUENTIAL.equals(multiInstance)) {
				multiInstance = PromptMessageComm.PARALLEL;
			}
		}
