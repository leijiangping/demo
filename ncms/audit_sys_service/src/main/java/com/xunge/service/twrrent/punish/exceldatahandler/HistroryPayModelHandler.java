...
public class HistroryPayModelHandler  extends ExcelDataHandlerDefaultImpl<HistoryPaymentModelVO> {
	@Autowired
	 ...
	 */
	public HistroryPayModelHandler(List<com.xunge.model.system.region.SysRegionVO> addresslist) {
	 ...
	 * @date 2017-7-10 6:31:09 
	 */
	public Object exportHandler(HistoryPaymentModelVO obj, String name, Object value) {
		//判断列表名并且判断值
	 ...
	 * @return
	 */
	public Object importHandler(HistoryPaymentModelVO obj, String name, Object value) {
		//判断列表名并且判断值
		if(name.equals(DateDisposeComm.BELONG_REGION)){
			for (com.xunge.model.system.region.SysRegionVO sysRegionVO : addresslist) {
