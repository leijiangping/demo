package com.xunge.service.activity.service.creator;
...
public class MultiInstanceActivityCreator extends RuntimeActivityCreatorSupport implements RuntimeActivityCreator {
	...
	private ActivityImpl createMultiInstanceActivity(ProcessEngine processEngine, ProcessDefinitionEntity processDefinition,
		...
		ActivityImpl clone = cloneActivity(processDefinition, prototypeActivity, cloneActivityId, PromptMessageComm.EXECUTION_LISTENERS, PromptMessageComm.PROPERTIES);
		//拷贝所有后向链接
		...
		clone.setScope(true);
		clone.setProperty(PromptMessageComm.MULTI_INSTANCE, isSequential ? PromptMessageComm.SEQUENTIAL : PromptMessageComm.PARALLEL);
