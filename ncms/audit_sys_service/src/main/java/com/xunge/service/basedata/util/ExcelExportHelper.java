...
public class ExcelExportHelper {
	...
	public static void setMeterExcelProperty(HSSFSheet sheet,List<MeterPerfVO> meterList) {
		...
		for (int i = 0; i < (meterList.size()); i++) {
			...
			Date stopTime=meterPerfVO.getStopTime();
			//float totalDegree=meterPerfVO.getTotalDegree();
			Integer totalState = null;
			if(meterPerfVO.getTotalState() != null){
				totalState=meterPerfVO.getTotalState();
			}
			//float equipmentDegree=meterPerfVO.getEquipmentDegree();
			Integer equipmentState = null;
			if(meterPerfVO.getEquipmentState() != null){
				equipmentState=meterPerfVO.getEquipmentState();
			}
			//float acDegree=meterPerfVO.getAcDegree();
			Integer acState = null;
			if(meterPerfVO.getAcState() != null){
				acState=meterPerfVO.getAcState();
			}
			if(StringUtils.isNoneBlank(meterId)){
				row.createCell(0).setCellValue(meterId);
			}
	...
	public static void setPowerExcelProperty(HSSFSheet sheet,List<PowerPerfVO> powerList) {
		...
		if(meterList != null && meterList.size() > 0){
			for (int i = 0; i < meterList.size(); i++) {
				...
				if (null != meterList.get(i)) {
					...
					// 第四步，创建单元格，并设置值
					row.createCell(0).setCellValue(StrUtil.isEmpty(datElectricMeterVO.getMeterCode()) ? "" : datElectricMeterVO.getMeterCode());
					row.createCell(1).setCellValue(datElectricMeterVO.getMeterType() == null ? "0" : dealMeterType(datElectricMeterVO.getMeterType()));
					row.createCell(2).setCellValue(StrUtil.isEmpty(datElectricMeterVO.getPrvId())?"":datElectricMeterVO.getPrvId());
					row.createCell(3).setCellValue(StrUtil.isEmpty(datElectricMeterVO.getPrvSname())?"":datElectricMeterVO.getPrvSname());
					row.createCell(4).setCellValue(StrUtil.isEmpty(datElectricMeterVO.getPregId())?"":datElectricMeterVO.getPregId());
					row.createCell(5).setCellValue(StrUtil.isEmpty(datElectricMeterVO.getPregName())?"":datElectricMeterVO.getPregName());
					row.createCell(6).setCellValue(StrUtil.isEmpty(datElectricMeterVO.getRegId())?"":datElectricMeterVO.getRegId());
					row.createCell(7).setCellValue(StrUtil.isEmpty(datElectricMeterVO.getRegName())?"":datElectricMeterVO.getRegName());
					row.createCell(8).setCellValue(datElectricMeterVO.getMeterState() == null ? "" : dealMeterState(datElectricMeterVO.getMeterState()));
					row.createCell(9).setCellValue(StrUtil.isEmpty(datElectricMeterVO.getAccountNumber()) ? "": datElectricMeterVO.getAccountNumber());
					row.createCell(10).setCellValue(datElectricMeterVO.getElectricmeterMultiply() == null? "0.0" : datElectricMeterVO.getElectricmeterMultiply()+"");
					row.createCell(11).setCellValue(datElectricMeterVO.getIsShare() == null ? "0" : dealIsShare(datElectricMeterVO.getIsShare()));
					row.createCell(12).setCellValue(datElectricMeterVO.getInstallDate() == null ? "" : dealDate(datElectricMeterVO.getInstallDate()));
					row.createCell(13).setCellValue(datElectricMeterVO.getInitialValue() == null ? "0.0" : datElectricMeterVO.getInitialValue()+"");
					row.createCell(14).setCellValue(datElectricMeterVO.getFlatValue() == null ? "0.0" : datElectricMeterVO.getFlatValue()+"");
					row.createCell(15).setCellValue(datElectricMeterVO.getTopValue() == null ? "0.0" : datElectricMeterVO.getTopValue()+"");
					row.createCell(16).setCellValue(datElectricMeterVO.getPeakValue() == null ? "0.0" : datElectricMeterVO.getPeakValue()+"");
					row.createCell(17).setCellValue(datElectricMeterVO.getValleyValue() == null ? "0.0" : datElectricMeterVO.getValleyValue()+"");
					row.createCell(18).setCellValue(datElectricMeterVO.getUpperValue() == null ? "0.0" : datElectricMeterVO.getUpperValue()+"");
					row.createCell(19).setCellValue(datElectricMeterVO.getFlatUpperValue() == null ? "0.0" : datElectricMeterVO.getFlatUpperValue()+"");
					row.createCell(20).setCellValue(datElectricMeterVO.getTopUpperValue() == null ? "0.0" : datElectricMeterVO.getTopUpperValue()+"");
					row.createCell(21).setCellValue(datElectricMeterVO.getPeakUpperValue() == null ? "0.0" : datElectricMeterVO.getPeakUpperValue()+"");
					row.createCell(22).setCellValue(datElectricMeterVO.getValleyUpperValue() == null ? "0.0" : datElectricMeterVO.getValleyUpperValue()+"");
					row.createCell(23).setCellValue(StrUtil.isEmpty(datElectricMeterVO.getMeterNote())?"":datElectricMeterVO.getMeterNote());
				}
			}
		}
	}
	...
	public static void setSupplierExcelProperty(HSSFSheet sheet,List<DatSupplierVO> list,int startIndex, int queryType) {
		for (int i = startIndex; i < (list.size()+startIndex); i++) {
			...
			row.createCell(4).setCellValue(vo.getIsDownshare());
			row.createCell(5).setCellValue(vo.getSupplierAddress());
			row.createCell(6).setCellValue(vo.getSupplierContact());
			row.createCell(7).setCellValue(vo.getSupplierTelephone());
			if(queryType == 1){
	...
	public static void setSupplierExcelProperty(HSSFSheet sheet,List<DatSupplierVO> list, int queryType) {
		for (int i = 0; i < list.size(); i++) {
			...
			row.createCell(2).setCellValue(vo.getPregName());
			row.createCell(3).setCellValue(vo.getRegName());
			row.createCell(4).setCellValue(vo.getIsDownshare() == JudgeComm.STATE_YES ? "是" : "否");
			row.createCell(5).setCellValue(vo.getSupplierAddress());
			row.createCell(6).setCellValue(vo.getSupplierContact());
			row.createCell(7).setCellValue(vo.getSupplierTelephone());
			if(queryType == DataFromComm.STATE_1){
				if(vo.getDataFrom()!=null){
					row.createCell(8).setCellValue(ResourceEnum.datafromEnum.getName(vo.getDataFrom()));
				}
			}
	...
	public static void setElecontractExcelProperty(HSSFSheet sheet,List<VEleContract> list, Integer opType) {
		for (int i = 0; i < list.size(); i++) {
			HSSFRow row = sheet.createRow((int) i + 1);
			VEleContract vo = list.get(i);
			// 第四步，创建单元格，并设置值
	...
	public static void setSiteExcelProperty(HSSFSheet sheet,List<DatBasesiteVO> list,int startIndex, Integer opType) {
		for (int i = startIndex; i < (list.size()+startIndex); i++) {
			...
			if(vo.getBasesiteBelong() != null && vo.getBasesiteBelong() != ""){
				row.createCell(5).setCellValue(ResourceEnum.resBelongEnum.getName(Integer.parseInt(vo.getBasesiteBelong())));
			}
	...
	public static void setSiteExcelProperty(HSSFSheet sheet,List<DatBasesiteVO> list, Integer opType) {
		if(list != null && list.size() > 0){
			for (int i = 0; i < list.size(); i++) {
				HSSFRow row = sheet.createRow((int) i + 1);
				DatBasesiteVO vo = list.get(i);
				// 第四步，创建单元格，并设置值
				if(vo.getAuditingState() != null){
					//-1:"未提交";9: "审核中";8: "审核不通过";0: "审核通过";
					String str = vo.getAuditingState() == ActivityStateComm.STATE_NORMAL ? ActivityStateComm.AUDIT_NORMAL:vo.getAuditingState() == ActivityStateComm.STATE_UNAPPROVE ?ActivityStateComm.AUDIT_UNAPPROVE:vo.getAuditingState() == ActivityStateComm.STATE_AUDIT ?ActivityStateComm.AUDIT_AUDIT:ActivityStateComm.AUDIT_UNCOMMITTED;
				...
				row.createCell(4).setCellValue(vo.getRegName());
				if(vo.getBasesiteBelong() != null && vo.getBasesiteBelong() != ""){
					String data = vo.getBasesiteBelong();
					String basesiteBelong = "";
					String[] data1 = data.split(",");
					for(int j = 0 ; j < data1.length ; j++){
						basesiteBelong += ResourceEnum.resBelongEnum.getName(data1[j])+",";
					}
					int a = basesiteBelong.indexOf(",");
					if(a > 0){
						basesiteBelong.substring(0,basesiteBelong.length()-1);
					}
					row.createCell(5).setCellValue(basesiteBelong == null ? "" : basesiteBelong);
				}
				if(vo.getBasesiteState() != null){
					row.createCell(6).setCellValue(ResourceEnum.resStateEnum.getName(vo.getBasesiteState()));
				}
	...
	public static void setResourceExcelProperty(HSSFSheet sheet,List<DatBaseresourceVO> list,int startIndex, Integer opType, String res) {
		for (int i = startIndex; i < (list.size()+startIndex); i++) {
			...
			row.createCell(3).setCellValue(vo.getPregName());
			row.createCell(4).setCellValue(vo.getRegName());
			if(vo.getRoomOwner() != null && vo.getRoomOwner() != ""){
				row.createCell(5).setCellValue(ResourceEnum.resBelongEnum.getName(vo.getRoomOwner()==null?0:Integer.parseInt(vo.getRoomOwner())));
			}
			if(vo.getBaseresourceState() != null){
	...
	public static void setResourceExcelProperty(HSSFSheet sheet,List<DatBaseresourceVO> list, Integer opType, String res) {
		if(list != null && list.size() > 0){
			for (int i = 0; i < list.size(); i++) {
				HSSFRow row = sheet.createRow((int) i + 1);
				DatBaseresourceVO vo = list.get(i);
				// 第四步，创建单元格，并设置值
				if(vo.getAuditingState() != null){
					row.createCell(0).setCellValue(ResourceEnum.auditStateEnum.getName(vo.getAuditingState()));
				}
				...
				row.createCell(4).setCellValue(vo.getRegName());
				if(vo.getRoomOwner() != null && vo.getRoomOwner() != ""){
					row.createCell(5).setCellValue(ResourceEnum.resBelongEnum.getName(vo.getRoomOwner()));
				}
				if(vo.getBaseresourceState() != null){
					row.createCell(6).setCellValue(ResourceEnum.resStateEnum.getName(vo.getBaseresourceState()==null?0:vo.getBaseresourceState()));
				}
	...
	private static String dealMeterType(int meterType){
		...
		String result=MeterTypeComm.METER_TYPE1_ZH;
		if(1==meterType){
			result=MeterTypeComm.METER_TYPE1_ZH;
		}
		else if(2==meterType){
			result=MeterTypeComm.METER_TYPE2_ZH;
		}
		return result;
	}
	...
	private static String dealMeterState(int meterState){
		...
		String result=StateComm.NORMAL_STR;
		if(StateComm.STATE_0==meterState){
			result=StateComm.NORMAL_STR;
		}
		else if(StateComm.STATE_9==meterState){
			result=StateComm.STOP_STR;
		}
		return result;
	}
	...
	private static String dealIsShare(int isShare){
		...
		String result=PromptMessageComm.NO;
		if(0==isShare){
			result=PromptMessageComm.NO;
		}
		else if(1==isShare){
			result=PromptMessageComm.YES;
		}
		return result;
	}
	...
	private static String dealCodeType(int codeType){
		...
		String result=PromptMessageComm.CID;
		if(1==codeType){
			result=PromptMessageComm.CID;
		}
		else if(2==codeType){
			result=PromptMessageComm.WORDS_CODEING;
		}
		return result;
	}
	private static String dealDate(Date date){
		if(date!=null){
			SimpleDateFormat dateFm = new SimpleDateFormat(SelfelecComm.FORMAT_yyyy_MM_dd_HH_mm_ss); 
	...
	private static String dealState(int state){
		String totals=state+"";
		if(0==state){
			totals=PromptMessageComm.NORMAL;
    	}
    	else if(1==state){
    		totals=PromptMessageComm.WORDS_CHANGE_TABLE;
    	}
    	else if(2==state){
    		totals=PromptMessageComm.WORDS_CLEARED;
    	}
		return totals;
	}
}
