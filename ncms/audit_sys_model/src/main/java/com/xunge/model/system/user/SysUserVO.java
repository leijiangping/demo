...
public class SysUserVO implements Serializable  {
    ...
    //用户角色关系表集合
    private List<RoleUserVO> listRoleUserVOs;
    //用户部门关系表集合
    private List<SysDepartmentUserVO> listSysDepartmentUserVOs;
	...
	public String toString() {
		return "SysUserVO [userId=" + userId + ", regId=" + regId
				...
				+ ", sysRegionVO=" + sysRegionVO + ", listRoleUserVOs="
				+ listRoleUserVOs + ", listSysDepartmentUserVOs="
				+ listSysDepartmentUserVOs + "]";
	}
	...
	public List<RoleUserVO> getListRoleUserVOs() {
		return listRoleUserVOs;
	}

	public void setListRoleUserVOs(List<RoleUserVO> listRoleUserVOs) {
		this.listRoleUserVOs = listRoleUserVOs;
	}

	public List<SysDepartmentUserVO> getListSysDepartmentUserVOs() {
		return listSysDepartmentUserVOs;
	}

	public void setListSysDepartmentUserVOs(
			List<SysDepartmentUserVO> listSysDepartmentUserVOs) {
		this.listSysDepartmentUserVOs = listSysDepartmentUserVOs;
	}
