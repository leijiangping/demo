...
public class TowerBillbalanceVO implements Serializable{
	...
	public TowerBillbalanceVO(String updateUserId) {
		this.towerbillbalanceId = SysUUID.generator();
	...
	private SysRegionVO agreeSysRegion;
	
	@Excel(name="站址所属地市",orderNum="11")
	private String towerStationAreaName;		// 站址所属地市
	private SysRegionVO towerStationSysRegion;
	...
	@Excel(name="油机发电服务费（包干）",orderNum="31")
	...
	@Excel(name="超过10%高等级服务站址额外维护服务费",orderNum="33")
	...
	@Excel(name="蓄电池额外保障费",orderNum="35")
	...
	private int ifbbuOnRoom2;		// RRU拉远时BBU是否放在铁塔公司机房2
	...
	private int ifbbuOnRoom3;		// RRU拉远时BBU是否放在铁塔公司机房3
	...
	private int currentTowerShareNum;		// 期末铁塔共享用户数

	@Excel(name="铁塔共享运营商1的起租日期",orderNum="71")
	...
	@Excel(name="铁塔共享运营商2的起租日期",orderNum="75")
	...
	@Excel(name="期末铁塔共享后基准价格1+2+3",orderNum="79")
	...
	private int currentRoomShareNum;		// 期末机房共享用户数

	@Excel(name="机房共享运营商1的起租日期",orderNum="89")
	...
	@Excel(name="机房共享运营商2的起租日期",orderNum="93")
...
//  期末机房共享后基准价格1+2+3
	...
	private BigDecimal currentRoomShareSumPriceDeductible;		// 期末机房共享后基准价格1+2+3（历史调增/已抵扣费用）
	...
	private int currentSupportingShareNum;		// 配套共享用户数

	@Excel(name="配套共享运营商1的起租日期",orderNum="107")
	...
	@Excel(name="配套共享运营商2的起租日期",orderNum="111")
	...
	@Excel(name="配套共享后基准价格1+2+3",orderNum="115")
	...
	@Excel(name="bbu安装在铁塔机房费",orderNum="117")
	...
	private int managerFeeShareNum;		// 维护费共享用户数

	@Excel(name="维护费共享运营商1的起租日期",orderNum="127")
	...
	@Excel(name="维护费共享运营商2的起租日期",orderNum="131")
	...
	@Excel(name="维护费折扣后金额1+2+3",orderNum="135")
	...
	private int praceFeeShareNum;		// 场地费共享用户数

	@Excel(name="场地费共享运营商1的起租日期",orderNum="141")
	...
	@Excel(name="场地费共享运营商2的起租日期",orderNum="145")
	...
	@Excel(name="场地费折扣后金额",orderNum="149")
	...
	private int powerInFeeShareNum;		// 电力引入费共享用户数

	@Excel(name="电力引入费共享运营商1的起租日期",orderNum="155")
	...
	@Excel(name="电力引入费共享运营商2的起租日期",orderNum="159")
	...
	@Excel(name="电力引入费折扣后金额",orderNum="163")
	...
	@Excel(name="WLAN费用",orderNum="165")
	...
	@Excel(name="产品服务费月费用合计（不含税）",orderNum="171")
	...
	private int locaOperator;		// 是否为锚定用户
	...
	public int getIfbbuOnRoom1() {
		return ifbbuOnRoom1;
	}
	public void setIfbbuOnRoom1(int ifbbuOnRoom1) {
	...
	public int getIfbbuOnRoom2() {
		return ifbbuOnRoom2;
	}
	public void setIfbbuOnRoom2(int ifbbuOnRoom2) {
	...
	public int getIfbbuOnRoom3() {
		return ifbbuOnRoom3;
	}
	public void setIfbbuOnRoom3(int ifbbuOnRoom3) {
	...
	public int getCurrentTowerShareNum() {
		return currentTowerShareNum;
	}
	public void setCurrentTowerShareNum(int currentTowerShareNum) {
	...
	public int getCurrentRoomShareNum() {
		return currentRoomShareNum;
	}
	public void setCurrentRoomShareNum(int currentRoomShareNum) {
	...
	public int getCurrentSupportingShareNum() {
		return currentSupportingShareNum;
	}
	public void setCurrentSupportingShareNum(int currentSupportingShareNum) {
	...
	public int getManagerFeeShareNum() {
		return managerFeeShareNum;
	}
	public void setManagerFeeShareNum(int managerFeeShareNum) {
	...
	public int getPraceFeeShareNum() {
		return praceFeeShareNum;
	}
	public void setPraceFeeShareNum(int praceFeeShareNum) {
	...
	public int getPowerInFeeShareNum() {
		return powerInFeeShareNum;
	}
	public void setPowerInFeeShareNum(int powerInFeeShareNum) {
	...
	public int getLocaOperator() {
		return locaOperator;
	}
	public void setLocaOperator(int locaOperator) {
	...
	public SysRegionVO getAgreeSysRegion() {
		return agreeSysRegion;
	}
	public void setAgreeSysRegion(SysRegionVO agreeSysRegion) {
		this.agreeSysRegion = agreeSysRegion;
	}
	public SysRegionVO getTowerStationSysRegion() {
		return towerStationSysRegion;
	}
	public void setTowerStationSysRegion(SysRegionVO towerStationSysRegion) {
		this.towerStationSysRegion = towerStationSysRegion;
	}
	@Override
