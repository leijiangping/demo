 ...
 *
 */
public class TowerAndMobileBillVO implements Serializable {
	...
	@Excel(name="账期月份",orderNum="2",format="yyyyMM",databaseFormat="yyyyMM",isImportField="true")
...
//	private Integer confirmState;		// 确认状态（1：正常 2:争议账单3：调整确认后账单）
	...
	@Excel(name="移动侧用电服务费（包干）",orderNum="15")
