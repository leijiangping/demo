 ...
 * @version 1.0.0 
 */
public class TowerRentInfoHandler  extends ExcelDataHandlerDefaultImpl<TowerRentInformationTowerVO> {
	 ...
	 * @author zhujj
	 */
	public TowerRentInfoHandler(List<SysRegionVO> addresslist) {
	 ...
	 * @author wangz
	 */
	public Object importHandler(TowerRentInformationTowerVO obj, String name, Object value) {
		//判断列表名并且判断值
		if(name.equals("区县")){
