 ...
 * @version 1.0.0 
 */
public class TowerRentBizChangeHandler  extends ExcelDataHandlerDefaultImpl<TowerRentinformationBizchangeVO> {
	 ...
	 * @author zhujj
	 */
	public TowerRentBizChangeHandler(List<SysRegionVO> addresslist) {
