...
public interface DatContractVOMapper {
    ...
    DatContractVO selectBySysID(String sysID);
    ...
    List<DatContractVO> selectRedisComDatContractVOByPrvId(String prv_id);

	DatContractVO selectByCode(String contractCode);
}