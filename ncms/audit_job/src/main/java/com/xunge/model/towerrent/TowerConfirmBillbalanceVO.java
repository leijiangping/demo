 ...
 */
public class TowerConfirmBillbalanceVO implements Serializable{
	
	private static final long serialVersionUID = 1L;
	
	public TowerConfirmBillbalanceVO() {
	...
	@Excel(name="账期月份",format="yyyyMM",databaseFormat="yyyyMM",isImportField="true")
	private String accountPeroid;		// 账期月份
	
	private String dataType;		// 数据类型（1：铁塔账单 2：移动账单）
	
	@Excel(name="产品业务确认单编号",isImportField="true")
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TowerConfirmBillbalanceVO other = (TowerConfirmBillbalanceVO) obj;
