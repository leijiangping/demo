 ...
 * 铁塔起租表
 * @author wangz
 * @date 2017-09-20 18:42:27
 */
public class TowerRentInformationTowerVO implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = -1571713288768158161L;
	
	public TowerRentInformationTowerVO() {
		this.rentinformationtowerId = SysUUID.generator();
    ...
    private Integer ifHasPowerCondition;
    //0-6点是否可上站
    @Excel(name="0-6点是否上站",orderNum="39",replace={"是_1","否_0"})
    private Integer isSpecEnterStation;
    //是否选择发电服务
    @Excel(name="是否选择发电服务",orderNum="41",replace={"是_1","否_0"})
    private Integer ifSelectPowerService;
    //电力保障服务模式id
    ...
    //是否标准建造成本
    @Excel(name="是否非标准建造成本",orderNum="50",replace={"是_1","否_0"})
    private Integer ifstandardBuildFee;
    //产品单元1：产品单元数（个）
    ...
    private Integer product1IfBBUOnRoom;
    //产品单元1：RRU是否上塔
    @Excel(name="产品单元1：RRU是否上塔",orderNum="62",replace={"是_1","否_0"})
    private Integer product1IsUpTowerRRU;
    ...
    private Integer product3IfBBUOnRoom;
    //产品单元3：RRU是否上塔
    @Excel(name="产品单元3：RRU是否上塔",orderNum="88",replace={"是_1","否_0"})
    private Integer product3IsUpTowerRRU;
    ...
    //铁塔建造成本
    @Excel(name="塔类非标准建造成本",orderNum="102")
    private BigDecimal towerPrice;
    //机房建造成本
    @Excel(name="机房非标准建造成本",orderNum="104")
    private BigDecimal roomPrice;
    //配套建造成本
    @Excel(name="配套费标准建造成本",orderNum="106")
    ...
    private Integer ifRRUDis;
    //包干电费
    @Excel(name="包干电费（元/年）",orderNum="126")
    private BigDecimal electricProtectionFee;
    //油机发电服务费
    @Excel(name="油机发电服务费（元/年）",orderNum="128")
    ...
    //业务单起租发起时间
    @Excel(name="业务单起租发起时间",orderNum="148",format="yyyy-MM-dd")
    ...
    //铁塔基准价格
    @Excel(name="铁塔基准价格")
    private BigDecimal towerBasePrice;
	...
	public Integer getIfHasPowerCondition() {
		return ifHasPowerCondition;
	}

	public void setIfHasPowerCondition(Integer ifHasPowerCondition) {
		this.ifHasPowerCondition = ifHasPowerCondition;
	}

	public Integer getIsSpecEnterStation() {
		return isSpecEnterStation;
	}

	public void setIsSpecEnterStation(Integer isSpecEnterStation) {
		this.isSpecEnterStation = isSpecEnterStation;
	}

	public Integer getIfSelectPowerService() {
		return ifSelectPowerService;
	}

	public void setIfSelectPowerService(Integer ifSelectPowerService) {
	...
	public void setOilGenerateElectricMethodId(
			String oilGenerateElectricMethodId) {
	...
	public Integer getIfstandardBuildFee() {
		return ifstandardBuildFee;
	}

	public void setIfstandardBuildFee(Integer ifstandardBuildFee) {
	...
	public Integer getProduct1IfBBUOnRoom() {
		return product1IfBBUOnRoom;
	}

	public void setProduct1IfBBUOnRoom(Integer product1IfBBUOnRoom) {
		this.product1IfBBUOnRoom = product1IfBBUOnRoom;
	}

	public Integer getProduct1IsUpTowerRRU() {
		return product1IsUpTowerRRU;
	}

	public void setProduct1IsUpTowerRRU(Integer product1IsUpTowerRRU) {
	...
	public Integer getProduct2IfBBUOnRoom() {
		return product2IfBBUOnRoom;
	}

	public void setProduct2IfBBUOnRoom(Integer product2IfBBUOnRoom) {
		this.product2IfBBUOnRoom = product2IfBBUOnRoom;
	}

	public Integer getProduct2IsUpTowerRRU() {
		return product2IsUpTowerRRU;
	}

	public void setProduct2IsUpTowerRRU(Integer product2IsUpTowerRRU) {
		this.product2IsUpTowerRRU = product2IsUpTowerRRU;
	}

	public String getProduct2BBUFee() {
		return product2BBUFee;
	}

	public void setProduct2BBUFee(String product2bbuFee) {
	...
	public Integer getProduct3IfBBUOnRoom() {
		return product3IfBBUOnRoom;
	}

	public void setProduct3IfBBUOnRoom(Integer product3IfBBUOnRoom) {
		this.product3IfBBUOnRoom = product3IfBBUOnRoom;
	}

	public Integer getProduct3IsUpTowerRRU() {
		return product3IsUpTowerRRU;
	}

	public void setProduct3IsUpTowerRRU(Integer product3IsUpTowerRRU) {
	...
	public Integer getIfRRUDis() {
		return ifRRUDis;
	}

	public void setIfRRUDis(Integer ifRRUDis) {
	...
	public void setOriginalOilGenerateElectricFee(BigDecimal originalOilGenerateElectricFee) {
	...
	public void setChangeRoomSupportingShareDisValue1(BigDecimal changeRoomSupportingShareDisValue1) {
	...
	public void setChangeRoomSupportingShareDisStartDate1(Date changeRoomSupportingShareDisStartDate1) {
	...
	public void setChangeRoomSupportingShareDisValue2(BigDecimal changeRoomSupportingShareDisValue2) {
	...
	public void setChangeRoomSupportingShareDisStartDate2(Date changeRoomSupportingShareDisStartDate2) {
	...
	public void setChangeTowerShareDisValue3(
			BigDecimal changeTowerShareDisValue3) {
	...
	public void setChangeRoomSupportingShareDisValue3(BigDecimal changeRoomSupportingShareDisValue3) {
	...
	public void setChangeRoomSupportingShareDisStartDate3(Date changeRoomSupportingShareDisStartDate3) {
	...
	public void setChangeMaintenanceFeeDisValue1(BigDecimal changeMaintenanceFeeDisValue1) {
	...
	public void setChangeMaintenanceFeeDisStartDate1(Date changeMaintenanceFeeDisStartDate1) {
	...
	public void setChangeMaintenanceFeeDisStartDate2(Date changeMaintenanceFeeDisStartDate2) {
	...
	public void setChangeMaintenanceFeeDisValue3(BigDecimal changeMaintenanceFeeDisValue3) {
	...
	public void setChangeElectricImportDisValue3(BigDecimal changeElectricImportDisValue3) {
	...
	public void setChangeElectricImportDisStartDate3(Date changeElectricImportDisStartDate3) {
	...
	public BigDecimal getTowerBasePrice() {
		return towerBasePrice;
	}

	public void setTowerBasePrice(BigDecimal towerBasePrice) {
		this.towerBasePrice = towerBasePrice;
	}
}