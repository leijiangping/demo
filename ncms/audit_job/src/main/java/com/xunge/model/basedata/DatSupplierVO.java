...
public class DatSupplierVO {
    ...
    public String getSupplierCode() {
        return StrUtil.isBlank(supplierCode)?"":supplierCode;
    }
    ...
    public String getSupplierName() {
        return StrUtil.isBlank(supplierName)?"":supplierName;
    }
    ...
    public String getSupplierSite() {
        return StrUtil.isBlank(supplierSite)?"":supplierSite;
    }
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((supplierSite == null) ? 0 : supplierSite.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DatSupplierVO other = (DatSupplierVO) obj;
		if (prvId == null) {
			if (other.prvId != null)
				return false;
		...
		if (supplierSite == null) {
			if (other.supplierSite != null)
				return false;
		} else if (!supplierSite.equals(other.supplierSite))
			return false;
		return true;
	}
